...
request.onload=function(){
    ...
    for(var i=0;i<250;i++){
       ...
       weatherdata(cname,...lang);
          ...
          console.log("Errorhas been handled"+cname+" "+e.message);
       }  
    }

function weatherdata(name,lat,lang){
var req= new XMLHttpRequest();
var url= 'https://api.openweathermap.org/data/2.5/weather?lat='+lat+'&lon='+lat+'&appid=4531d07d5fba29865532651e671e760d' 
